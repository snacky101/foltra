(plugin, inputJSON) => {
  ...
  else if (event.type === 'tree-icons') handler = plugin.treeIcons;
  ...
  if (event.type === 'tree-icons' && typeof handler !== 'function') throw new Error('Plugin treeIcons handler is missing');
