...
사이드바의 노트와 폴더는 드래그하여 다른 폴더로 이동할 수 있습니다. 폴더 안의 파일 행이나 여백에도 놓을 수 있고, **NOTES** 제목이나 최상위 영역에 놓으면 폴더 밖으로 이동합니다.
...
| 실수한 기록 되찾기       | 노트·폴더·DB 휴지통과 복원, 전체 영구 삭제, 백업 내보내기·복원                            | [CLI의 관리 명령](docs/CLI.md)                       |
