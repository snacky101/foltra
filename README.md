...
[**macOS 다운로드**](https://github.com/snacky101/foltra/releases/tag/v0.1.0-preview.11) · [이번 버전의 변화](docs/releases/v0.1.0-preview.11.md) · [CLI 안내](docs/CLI.md) · [개발 안내](docs/DEVELOPMENT.md)
...
1. [**DMG 다운로드**](https://github.com/snacky101/foltra/releases/download/v0.1.0-preview.11/Foltra_0.1.0-preview.11_aarch64.dmg)를 열고 **Foltra.app → Applications**로 옮깁니다.
