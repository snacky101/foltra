...
앱 업데이트·Git 동기화 확장·휴지통 관리·macOS 텍스트 대치와 Makefile을 **[v0.1.0-preview.2](https://github.com/snacky101/foltra/tree/v0.1.0-preview.2)**로 게시했습니다. 배포 소스는 `d07ae3c5a110275dafc55f99cdc62038191d776e`이며 npm/Cargo/Tauri 버전과 원격 태그가 일치합니다. 기존 `preview.1` 사용자는 DMG로 한 번 수동 교체해야 이후 앱 내 업데이트를 사용할 수 있습니다. 기존 vault는 그대로 사용할 수 있습니다. 아래 작업별 미커밋·미배포 문장은 해당 작업 완료 당시의 이력입니다.
